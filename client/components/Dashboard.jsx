...
export default function Dashboard() {
  ...
  const handleActionClick = (action) => {
    toast({
      ...
      description: `Starting ${action.toLowerCase()}...`,
      duration: 3000,
    });
  };
        ...
        {[
          {
            ...
            tooltip: "Total number of batches processed",
          },
          {
            label: "Gas Saved",
            ...
            tooltip: "Percentage of gas saved vs L1",
          },
          {
            ...
            tooltip: "Average time to finality",
          },
          {
            ...
            highlight: true,
            tooltip: "Current sequencer status",
          },
        ].map((metric, idx) => (
          <Card
            key={idx}
            className={cn(
              "bg-gradient-to-br from-card to-card/50 border-border/40 backdrop-blur-sm group cursor-help transition-all duration-300 hover:border-neon-blue/50",
              metric.highlight && "border-neon-blue/50 shadow-glow"
            )}
        ...
        <CardContent>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            {[
              ...
              <div
                key={idx}
                className="p-3 bg-secondary/30 border border-border/30 rounded-lg text-center hover:bg-secondary/50 transition-colors"
              >
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2 text-xs">
                      <span className="px-2 py-1 bg-neon-blue/20 text-neon-blue rounded border border-neon-blue/30 font-medium flex items-center gap-1 group-hover:shadow-glow transition-shadow">
